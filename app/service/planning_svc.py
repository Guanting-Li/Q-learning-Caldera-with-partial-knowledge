...
class PlanningService(PlanningServiceInterface, BasePlanningService):
    ...
    async def execute_planner(self, planner, publish_transitions=True):
        ...
        """
        async def _publish_bucket_transition(bucket: object) -> object:
    ...
    async def _generate_new_links(self, operation: object, agent: object, abilities: object, link_status: object) -> object:
